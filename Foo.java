...
class OrderLine {
	...
	public OrderLine(Item item, int quantity) throws Exception {
		...
		assert quantity > 0;
		// Assign variables to the class variables using 'this'
		this.item = item;
...
class Order {
	...
	public void add(OrderLine o) throws Exception {
		...
		// Create instance of the orderLines
		if(null == orderLines){
...
class calculator {
	...
	//This code returns a double value with 2 decimal values
	...
	public void calculate(Map<String, Order> o) {
		...
		for (Map.Entry<String, Order> entry : o.entrySet()) {
			...
			for (int i = 0; i < r.size(); i++) {
				...
				//The method Math.floor gives the largest integer that is less than or equal to the argument.
...
public class Foo {
	...
	public static void main(String[] args) throws Exception {
		...
		// c.clear() clears the 'c' instance of Order object. Since there is only one instance 
		//with single heap memory location, any modification to the instance reflects in all the places its being used. 
		c = new Order();
